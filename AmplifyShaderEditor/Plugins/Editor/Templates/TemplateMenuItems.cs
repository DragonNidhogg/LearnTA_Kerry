...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Templates/DoubleUnlitPass", false, 85 )]
		public static void ApplyTemplateTemplatesDoubleUnlitPass()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "f52d9f93a9749e54c8dc07544ed42552" );
		}
